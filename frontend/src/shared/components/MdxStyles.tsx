...
.mdx-content h4 { font-size: 1.1rem; }

.mdx-content p { margin: 0.5rem 0; }
...
[data-image-size="small"] .mdx-content img {
  width: min(480px, 100%);
}

[data-image-size="medium"] .mdx-content img {
  width: min(720px, 100%);
}

[data-image-size="large"] .mdx-content img {
